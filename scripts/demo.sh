...
proofforge claim-add DEMO-001 --id CLAIM-001 --text "The synthetic endpoint returned the recorded response." --evidence evidence/originals/request.txt --evidence evidence/originals/response.txt --severity info
...
echo "ProofForge v0.1.3.1 demo complete."
